    ...
    <div className="container mx-auto pt-8 overflow-auto">
      <div className="xl:pr-[30rem]">
        ...
        <form className="max-w-lg mx-auto">
          ...
          <div className="mb-4">
            <label className="input input-bordered flex items-center gap-4"><span className="font-semibold">Age</span>
              <input
                type="number"
                name="age"
                value={userInfo.age}
          ...
          <div className="mb-4">
            <label className="input input-bordered flex items-center gap-4"><span className="font-semibold">Gender</span>
              <select
                name="gender"
          ...
          <div className="mb-4">
            <label className="input input-bordered flex items-center gap-4"><span className="font-semibold">Job Type</span>
              <select
                name="job_type"
          ...
          <div className="mb-4">
            <label className="input input-bordered flex items-center gap-4"><span className="font-semibold">Work Type</span>
              <select
                name="work_type"
          ...
          <div className="mb-4">
            <label className="input input-bordered flex items-center gap-4"><span className="font-semibold">Height (in feet)</span>
              <input
                type="number"
                name="height"
          ...
          <div className="mb-4">
            <label className="input input-bordered flex items-center gap-4"><span className="font-semibold">Weight (in lbs)</span>
              <input
                type="number"
                name="weight"
          ...
          <div className="mb-4">
            <label className="input input-bordered flex items-center gap-4"><span className="font-semibold">Exercise Hours (per week)</span>
              <input
                type="number"
                name="exercise_hours"
          ...
          <div className="mb-4">
            <label className="input input-bordered flex items-center gap-4"><span className="font-semibold">Work Hours (per week)</span>
              <input
                type="number"
                name="work_hours"
          ...
          <div className="mb-4">
            <label className="input input-bordered flex items-center gap-4"><span className="font-semibold">Cooking Hours (per week)</span>
              <input
                type="number"
                name="cooking_hours"
          ...
          <div className="mb-4">
            <label className="input input-bordered flex items-center gap-4"><span className="font-semibold">Proficiency in Cooking</span>
              <select
          ...
          <div className="mb-4">
            <label className="input input-bordered flex items-center gap-4"><span className="font-semibold">Goals</span>
              <select
                name="goals"
          ...
          <div className="mb-4">
            <label className="input input-bordered flex items-center gap-4"><span className="font-semibold">Diet Type</span>
              <select
                name="diet_type"
          ...
          <div className="mb-4">
            <label className="input input-bordered flex items-center gap-4"><span className="font-semibold">Allergies</span>
              <select
                name="allergies"
          ...
          <div className="mb-4">
            <label className="input input-bordered flex items-center gap-4"><span className="font-semibold">Cuisine Preference</span>
              <select
          ...
          <div className="mb-4">
            <label className="input input-bordered flex items-center gap-4"><span className="font-semibold">Grocery Frequency</span>
              <select
          ...
          <div className="mb-4">
            <label className="input input-bordered flex items-center gap-4"><span className="font-semibold">Budget (in dollars)</span>
              <input
                type="number"
                name="budget"
